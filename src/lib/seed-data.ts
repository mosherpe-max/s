...
export const getGlobalStarterMenuItems = (): Omit<StarterMenuItem, 'id'>[] => [
  ...
  { name: "Coors Light (canned)", description: "Chilled 12oz can.", price: 6.00, category: "Beer", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('lager can'), sortOrder: 3 },
  { name: "Modelo Especial (canned)", description: "Chilled 12oz can.", price: 7.00, category: "Beer", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('lager can'), sortOrder: 4 },
  { name: "Heineken (canned)", description: "Chilled 12oz can.", price: 7.00, category: "Beer", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('lager can'), sortOrder: 5 },
  ...
  { name: "White Claw (canned)", description: "Black Cherry or Mango.", price: 7.00, category: "Beer", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('lager can'), sortOrder: 7 },
  { name: "Truly (canned)", description: "Wild Berry or Pineapple.", price: 7.00, category: "Beer", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('lager can'), sortOrder: 8 },
  ...
  { name: "Cocktail", description: "Premium spirit with your choice of mixer.", price: 11.00, category: "Spirits", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('blue cocktail'), suggestedModifierGroups: ["Ice Preference", "Mixer", "Pour Size"], sortOrder: 10 },
  ...
  { name: "Soda (can)", description: "Classic cola, diet, or lemon-lime.", price: 3.50, category: "Soft Drinks", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('cola can'), sortOrder: 13 },
  { name: "Hot Dog", description: "All-beef dog on a toasted bun.", price: 8.50, category: "Handhelds", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('hot dog'), suggestedModifierGroups: ["Hot Dog Style", "Hot Dog Toppings"], sortOrder: 14 },
  { name: "Chips", description: "Kettle cooked sea salt.", price: 3.00, category: "Snacks", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('potato chips'), sortOrder: 15 },
  { name: "Candy Bar", description: "Snickers, Hershey's, or KitKat.", price: 2.50, category: "Snacks", venueType: ["golf"], serviceMode: "beverageCart", imageUrl: getImg('chocolate bar'), sortOrder: 16 },
  ...
  { name: "Cheeseburger", description: "Angus beef with American cheese.", price: 15.00, category: "Handhelds", venueType: ["golf"], serviceMode: "clubhouse", imageUrl: getImg('burger meal'), suggestedModifierGroups: ["Doneness", "Cheese", "Toppings", "Sauces", "Bun", "Side Swap", "Allergy Flag"], sortOrder: 101 },
  { name: "Chicken Sandwich", description: "Grilled or crispy breast.", price: 13.50, category: "Handhelds", venueType: ["golf"], serviceMode: "clubhouse", imageUrl: getImg('burger meal'), suggestedModifierGroups: ["Cheese", "Toppings", "Sauces", "Bun", "Side Swap"], sortOrder: 102 },
  ...
  { name: "Nachos", description: "Loaded with cheese and jalapenos.", price: 14.00, category: "Appetizers", venueType: ["golf"], serviceMode: "clubhouse", imageUrl: getImg('loaded nachos'), suggestedModifierGroups: ["Nacho Protein", "Nacho Toppings", "Mexican Add-ons", "Cheese Amount"], sortOrder: 107 },
  { name: "Fountain Drink", description: "20oz bottomless refill.", price: 3.50, category: "Soft Drinks", venueType: ["golf"], serviceMode: "clubhouse", imageUrl: getImg('soft-drink-1'), suggestedModifierGroups: ["Drink Size"], sortOrder: 119 },
  { name: "Pitcher of Beer", description: "64oz cold draft for the lane.", price: 20.00, category: "Beer", venueType: ["bowling"], serviceMode: "laneService", imageUrl: getImg('craft beer'), sortOrder: 1 },
