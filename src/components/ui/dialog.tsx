...
interface DialogContentProps
  ...
  // Lets a colored (e.g. brand-blue) dialog header opt its close icon into a
  // matching color - left unset, the close icon keeps its original
  // appearance, so every dialog that doesn't pass this is unaffected.
