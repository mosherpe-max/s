...
export default function SolutionAdminPage() {
  ...
  const handleInitializeLibrary = async () => {
    ...
    } catch (e) { toast({ variant: "destructive", title: "Setup Failed" }); } finally { setIsInitializingLibrary(false); }
  };
